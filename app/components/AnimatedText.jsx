...
export default function AnimatedText({
  ...
  return (
    <div>
      <h1
        className={`${fontSize} font-bold tracking-tight text-black ${fontSizeSM}`}
      >
        {" "}
        <span className="relative whitespace-nowrap text-whitefont-alliance">
          <motion.svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-1/3 fill-lotus-primary-400"
