"use client";
import { iconsForTooltips } from "./globaIcon";
import React, { useState } from "react";
import { tooltipsCodeCopy } from "./codeCopy";
...
export const TooltipContent = () => {
  ...
  return (
    <div className="h-screen max-h-80 grid place-items-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 ">
      {tooltipContent.map((tooltip, index) => (
        ...
        >
          ...
          {tooltipsCodeCopy.map((tooltip, tooltipIndex) => (
            <div
